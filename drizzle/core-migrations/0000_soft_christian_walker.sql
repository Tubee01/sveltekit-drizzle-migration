...
CREATE UNIQUE INDEX IF NOT EXISTS "idx_uq_workspace_name_owner" ON "core"."workspace" ("name","owner_id");--> statement-breakpoint
DO $$ BEGIN
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "core"."workspace" ADD CONSTRAINT "workspace_owner_id_user_id_fk" FOREIGN KEY ("owner_id") REFERENCES "core"."user"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
